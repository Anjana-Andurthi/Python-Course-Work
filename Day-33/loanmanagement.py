...
class Loan(ABC):
    ...
    def repay(self, amount):
        ...
        if self.__balance == 0:
            self.status = "Closed"
            print("Loan closed successsfully")
...
Anjana = Customer(1,'Anjana','anjana@gmail.com',9876543210,21,50000,750)
Anjana.display_customer()
print("Loan Eligibility:",Anjana.check_eligibility())


Amani = Customer(2,'Amani','amani@gmail.com',9876543210,21,60000,600)
Amani.display_customer()
print("Loan Eligibility:",Amani.check_eligibility())

home_loan = HomeLoan("HL1001",Anjana,500000,8.5,10)
Anjana.display_customer()
print("\nLoan Application")
print("----------------------")
print(home_loan)
